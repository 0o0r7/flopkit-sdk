...
flowchart TD
    ...
    style A fill:#07111f,stroke:#55d9ff,stroke-width:2px,color:#d7e3f4
    style B fill:#07111f,stroke:#55d9ff,stroke-width:2px,color:#d7e3f4
    style C fill:#07111f,stroke:#62e6a7,stroke-width:2px,color:#d7e3f4
    style D fill:#07111f,stroke:#62e6a7,stroke-width:2px,color:#d7e3f4
    style E fill:#07111f,stroke:#62e6a7,stroke-width:2px,color:#d7e3f4
    style F fill:#07111f,stroke:#ffd166,stroke-width:2px,color:#d7e3f4
    style G fill:#07111f,stroke:#ffd166,stroke-width:2px,color:#d7e3f4
```
...
The CLI help is available after the core installation, without installing the development toolchain. The exact command list is generated by the current parser in `sdk/src/flopkit/cli.py`; use `flopkit --help` rather than relying on a frozen output block.
...
The current CLI includes identity, messaging, notes, discovery, contribution proofs, TCLK/1, and delegation commands. The wizard provides the guided six-area interface documented in [Interactive Wizard](wizard.md).
